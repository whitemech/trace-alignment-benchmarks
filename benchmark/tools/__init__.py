...
from benchmark.tools.tral import DEFAULT_BIN_TRAL_PATH, TralToolFD, TralToolSYMBA
...
# TraceAlignment + 1 encoding
tool_registry.register(
    ToolID.TRAL_STRIPS_SYMBA,
    tool_cls=TralToolSYMBA,
    binary_path=DEFAULT_BIN_TRAL_PATH,
    encoding=Encoding.STRIPS,
)
