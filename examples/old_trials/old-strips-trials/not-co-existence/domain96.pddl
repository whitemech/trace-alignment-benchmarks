...
(:action add-a_accepted_complete-ct1
:precondition (currstate s_0_2) 
:effect (and (not (currstate s_0_2)) (currstate s_0_0)  (increase (total-cost) 1))
)

(:action sync-a_accepted_complete-ct1
...
:precondition (and (currstate t14) (not (currstate s_0_2)) (not (currstate s_0_3)) )
...
:precondition (and (currstate t45) (currstate s_0_2) )
:effect (and (currstate s_0_abstract) (not (currstate s_0_2)) )
)

(:action goto-abstract_states-cs1
:precondition (and (currstate t45) (currstate s_0_3) )
